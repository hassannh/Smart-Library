...
<div class="modal-body flex justify-center items-center h-screen">
  <form class="w-full max-w-md" action="insertData" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-4">
    ...
    <div class="mb-4">
      <input type="text" placeholder="Enter book price" name="price" style="width: 100%;" class="px-4 py-2 rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 ">
    </div>
    <div class="mb-4">
