                ...
                <div class="flex flex-wrap justify-center">
                    <div class="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                        <div class="relative">
                            ...
                            <img alt="..." src="{{ env('PICTURES') }}/hassan.jpg" class="shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-150-px">
...
<!-- 
                            <a href="{{ route('deleteProfile', ['id' => auth()->id()]) }}"> <button class="bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150" type="submit">
                                    delete
                                </button>
                            </a> -->


                            <form action="{{ route('deleteProfile', ['id' => auth()->id()]) }}" method="POST">
                                @csrf
                                @method('DELETE')
